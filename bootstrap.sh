...
gcc -c -o .modules-B4E4FE1B-$MACHINE-kissmalloc_src/malloc.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -I$SOURCE/src/include $SOURCE/src/malloc.c &
wait
gcc -o libkissmalloc.so.0.1.0 -shared -pthread -Wl,-soname,libkissmalloc.so.0 .modules-B4E4FE1B-$MACHINE-kissmalloc_src/malloc.o -L. -Wl,--enable-new-dtags,-rpath='$ORIGIN',-rpath='$ORIGIN'/../lib,-rpath-link=$PWD
...
gcc -c -o .modules-6C99ABEF-$MACHINE-tools_bench/main.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -I$SOURCE/src/include $SOURCE/tools/bench/main.c &
wait
...
gcc -c -o .modules-07136E57-$MACHINE-tools_bench_threads/main.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -I$SOURCE/src/include $SOURCE/tools/bench_threads/main.c &
wait
