...
gcc -c -o .modules-B4E4FE1B-$MACHINE-kissmalloc_src/kissmalloc.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -DKISSMALLOC_OVERLOAD_LIBC -DKISSMALLOC_OVERLOAD_ $SOURCE/src/kissmalloc.c &
g++ -c -o .modules-B4E4FE1B-$MACHINE-kissmalloc_src/kissmalloc_new.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -DKISSMALLOC_OVERLOAD_LIBC -DKISSMALLOC_OVERLOAD_ $SOURCE/src/kissmalloc_new.cc &
wait
...
gcc -c -o .modules-6C99ABEF-$MACHINE-tools_bench/main.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -DKISSMALLOC_OVERLOAD_LIBC -DKISSMALLOC_OVERLOAD_ -I$SOURCE/src $SOURCE/tools/bench/main.c &
wait
...
gcc -c -o .modules-07136E57-$MACHINE-tools_bench_threads/main.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -DKISSMALLOC_OVERLOAD_LIBC -DKISSMALLOC_OVERLOAD_ -I$SOURCE/src $SOURCE/tools/bench_threads/main.c &
wait
...
g++ -c -o .modules-CC779790-$MACHINE-tools_bench_std_list/main.o -DNDEBUG -O2 -fPIC -Wall -pthread -pipe -D_FILE_OFFSET_BITS=64 -DCCBUILD_BUNDLE_VERSION=0.1.0 -DKISSMALLOC_OVERLOAD_LIBC -DKISSMALLOC_OVERLOAD_ -I$SOURCE/src $SOURCE/tools/bench_std_list/main.cc &
wait
